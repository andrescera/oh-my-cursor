# oh-my-cursor Deeplinks

Share individual components with one click. Deeplinks open Cursor and install the component after user review.

## Rules

| Rule | Deeplink |
|------|----------|
| Orchestrator | `cursor://anysphere.cursor-deeplink/rule?name=orchestrator&text=Root%20Thread%20%3D%20Dispatcher.%20NEVER%20a%20Worker.` |
| Coding Standards | `cursor://anysphere.cursor-deeplink/rule?name=coding-standards&text=Hard%20Constraints%3A%20No%20as%20any%2C%20no%20empty%20catch%2C%20no%20ts-ignore` |
