...
- Delegate implementation only via **Task**: `subagent_type="sisyphus-junior"` for implementation tasks. Each downstream **Task** must use the same six-section brief format.
