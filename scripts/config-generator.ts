...
const MODEL_ENUM_HEADER_COMMENT =
  "<!-- Generated by config-generator.ts --sync-rules from hooks/lib/known-models.ts KNOWN_CURSOR_MODELS. Hook-time enforcement (composer) is CANONICAL; this table is informative for the root thread. -->"
...
function syncRules(): void {
  ...
  const enumBlock = buildMarkedBlock(
    ...
    buildModelEnumTable(KNOWN_CURSOR_MODELS),
  )
